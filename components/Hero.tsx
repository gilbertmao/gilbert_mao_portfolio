    ...
    <div className="pb-20 pt-36">
      ...
      <div className="flex justify-center relative my-20 z-10">
        ...
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          3rd year undergraduate student at Georgia Tech studying computer science with full-stack and ML development experience. Feel free to take a look around to see if anything piques your interest; I&apos;d love to chat further!
          </p>
